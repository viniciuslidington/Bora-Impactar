    ...
    >
      <div className="relative z-21 flex flex-col gap-6 rounded bg-white p-10">
        ...
        <span className="flex gap-5">
          <Button
            className={
              "h-12 w-[180px] cursor-pointer rounded border-2 border-red-400 text-red-400 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.12)] transition-all duration-100 hover:bg-red-100"
            }
            onClick={() => setModalEncerrar(false)}
          >
            {content1}
          ...
          <Button
            onClick={onClick}
            className={
              "h-12 w-[180px] cursor-pointer rounded-sm border-2 border-red-400 bg-red-400 px-2 text-base font-medium text-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.12)] transition-all duration-100 ease-in hover:bg-red-300 disabled:opacity-70"
            }
          >
            {content2}
          </Button>
